                        ...
                        <tr>
                            ...
                            <td>
                                <a type="button" class="btn btn-info btn-xs"
                                   ...
                                   href="<?php _e(ADMIN_MANAGE . "/cities/{$cit->id}/edit"); ?>">
                                    <span class="glyphicon glyphicon-pencil"></span>
                                </a>
                                <a type="button" class="btn btn-danger btn-xs"
                                   title="<?php echo $lang->t('admin|btn_delete'); ?>"
                                   href="<?php _e(ADMIN_MANAGE . "/cities/{$cit->id}/delete"); ?>">
            ...
            <form class="form" role="form" method="post" action="<?php _e(ADMIN_MANAGE . '/cities'); ?>">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" name="description"
                           ...
                           value="<?php if ($city && $city->description) {
                               _e($city->description);
                           } ?>" required/>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" name="sort"
                           ...
                           value="<?php if ($city && $city->sort) {
                               _e($city->sort);
                           } ?>" required/>
                </div>
                <input type="hidden" name="id" value="<?php if ($city && $city->id) {
                    _e($city->id);
                } ?>">
