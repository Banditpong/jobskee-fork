...
<?php include 'flash.php'; ?>
    ...
    <p class="pull-right">
        <a type="submit" class="btn btn-info btn-md"
           href="<?php _e(ADMIN_URL . "pages/new"); ?>"><?php echo $lang->t('admin|btn_add_new'); ?><?php echo $lang->t('admin|site_pages'); ?></a>
    </p>
                ...
                <tr>
                    ...
                    <td>
                        <a type="button" class="btn btn-info btn-xs" title="<?php echo $lang->t('admin|btn_edit'); ?>"
                           href="<?php _e(ADMIN_URL . "pages/edit/{$page->id}"); ?>">
                            <span class="glyphicon glyphicon-pencil"></span>
                        </a>
                        <a type="button" class="btn btn-danger btn-xs"
                           title="<?php echo $lang->t('admin|btn_delete'); ?>"
                           href="<?php _e(ADMIN_URL . "pages/delete/{$page->id}"); ?>">
