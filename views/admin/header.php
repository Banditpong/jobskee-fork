                ...
                <?php if (userIsValid()): ?>
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle"
                           data-toggle="dropdown"><?php echo $lang->t('link|categories'); ?> <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <?php foreach ($categories as $cat): ?>
                                <li>
                                    <a href="<?php _e(ADMIN_URL . "categories/{$cat->id}/{$cat->url}"); ?>"><?php _e($cat->name); ?></a>
                                </li>
                            <?php endforeach; ?>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle"
                           data-toggle="dropdown"><?php echo $lang->t('link|cities'); ?> <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <?php foreach ($cities as $cit): ?>
                                <li>
                                    <a href="<?php _e(ADMIN_URL . "cities/{$cit->id}/{$cit->url}"); ?>"><?php _e($cit->name); ?></a>
                                </li>
                            <?php endforeach; ?>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle"
                           data-toggle="dropdown"><?php echo $lang->t('admin|manage'); ?> <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li>
                                <a href="<?php _e(ADMIN_URL); ?>applications"><?php echo $lang->t('admin|job_applications'); ?></a>
                            </li>
                            <li>
                                <a href="<?php _e(ADMIN_URL); ?>manage/categories"><?php echo $lang->t('link|categories'); ?></a>
                            </li>
                            <li>
                                <a href="<?php _e(ADMIN_URL); ?>manage/cities"><?php echo $lang->t('link|cities'); ?></a>
                            </li>
                            <li>
                                <a href="<?php _e(ADMIN_URL); ?>subscribers"><?php echo $lang->t('admin|subscribers'); ?></a>
                            </li>
                            <li><a href="<?php _e(ADMIN_URL); ?>pages"><?php echo $lang->t('admin|site_pages'); ?></a>
                            </li>
                            <li><a href="<?php _e(ADMIN_URL); ?>blocks"><?php echo $lang->t('admin|site_blocks'); ?></a>
                            </li>
                            <li>
                                <a href="<?php _e(ADMIN_URL); ?>jobs/upload"><?php echo $lang->t('admin|bulk_upload'); ?></a>
                            </li>
                            <li><a href="<?php _e(ADMIN_URL); ?>ban"><?php echo $lang->t('admin|ban_list'); ?></a></li>
                            <li>
                                <a href="<?php _e(ADMIN_URL); ?>jobs/expire"><?php echo $lang->t('admin|expire_jobs'); ?></a>
                            </li>
                        </ul>
                    </li>
