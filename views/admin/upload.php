    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="form-group">
                ...
                <form class="form-horizontal" role="form" action="<?php _e(ADMIN_URL . 'jobs/upload'); ?>" method="post"
                    ...
                    <input type="file" class="filestyle" data-classButton="btn btn-default btn-lg" name="csv"
                           accept="text/csv" data-buttonText="<?php echo $lang->t('jobs|btn_file'); ?>"
                           required/><br/><br/>
