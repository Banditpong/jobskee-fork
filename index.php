...
$app->get('/[{page}]', function ($request, $response, $args) use ($app) {
    ...
    if (isset($args['page']) && $args['page'] != '') {
        ...
        if ($content && $content->id) {
            ...
            return $this->get('PhpRenderer')->render($response, THEME_PATH . 'page.php',array('lang' => $lang,
                'seo_url'=>$seo_url,
                'seo_title'=>$seo_title,
                'seo_desc'=>$seo_desc,
                'content'=>$content,
        ...
        return $this->get('PhpRenderer')->render($response, THEME_PATH . 'home.php',array('lang' => $lang,
            'flash'=>  $this->get('flash')->getMessages(),
            'seo_url'=> $seo_url,
            'seo_title'=> $seo_title,
            'seo_desc'=> $seo_desc,
